...
<link href="{{ asset('bower_components/bootstrap-daterangepicker/daterangepicker.css') }}" rel="stylesheet">
 ...
 <script src="{{ asset('bower_components/jquery/dist/jquery.min.js') }}"></script>
  ...
  <link rel="stylesheet"
        ...
        <style>
         tr.lapriskbisnis {border: 1px solid #ddd;padding: 10px;font-size: 13px;text-align: center;}
          table#lapriskbisnis {border-collapse: collapse;padding:2px;}table, td, th {border: 1px solid black;font-size: 13px;padding:2px;}
          </style>
      </head>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">{{cek_rolenya()}}-{{ Auth::user()->name }}</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
