...
function exportexcel(){
    ...
    if (confirm("Apakah anda yakin ?") == true) {
            window.location.assign("{{url('export_excel')}}")
     }
}
        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    ...
                    <a href="{{url('export_excel?unit='.$unitkerja.'&tingkat='.$tingkat.'&periode='.$periode)}}" class="btn btn-info my-3" target="_blank"><i class="fa  fa-file-excel-o" title=""> Export Excel</i></a>    
                ...
                <div class="box-body">
                    <table width="100%" border-collapse="collapse">
                        ...
                        @foreach(detail_risiko_get(risiko_bisnis_get($unitkerja,$periode)) as $no=> $resik)
