            ...
            <table id="tbluser" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td align="center">
                      @if($data->status=='1')
                      <a class="btn btn-success btn-xs" onclick="tutupotorisasi({{$data->nik}});"><i class="fa fa-power-off" title="Tutup otorisasi"></i></a>
                      @else
                      <a class="btn btn-danger btn-xs" onclick="bukaotorisasi({{$data->nik}});"><i class="fa fa-power-off" title="Buka otorisasi"></i></a>
                      @endif
                  </td>
                  </tr>
                  @endforeach
