            ...
            <table id="tbluser" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td align="center">
                      @if($data->status=='1')
                      <a class="btn btn-success btn-xs" onclick="nonaktifuser({{$data->nik}});"><i class="fa fa-power-off" title="Non aktifkan"></i></a>
                      @else
                      <a class="btn btn-danger btn-xs" onclick="aktifkanuser({{$data->nik}});"><i class="fa fa-power-off" title="Aktifkan"></i></a>
                      @endif
                  </td>
